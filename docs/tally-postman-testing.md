...
| 25 | GET | `/api/MastersAPI/company-master` | ⬜ Pending |
| 26 | POST | `/api/MastersAPI/update-company-master` | ⬜ Pending |
| 27 | GET | `/api/MastersAPI/ledger-group` | ⬜ Pending |
| 28 | GET | `/api/MastersAPI/ledger-master` | ⬜ Pending |
| 29 | GET | `/api/MastersAPI/stock-master` | ⬜ Pending |
| 30 | GET | `/api/MastersAPI/stock-group` | ⬜ Pending |
| 31 | GET | `/api/MastersAPI/stock-category` | ⬜ Pending |
| 32 | GET | `/api/MastersAPI/statutory-master` | ⬜ Pending |
| 33 | GET | `/api/PayrollAPI/employee-group` | ⬜ Pending |
| 34 | GET | `/api/PayrollAPI/employee` | ⬜ Pending |
| 35 | GET | `/api/PayrollAPI/pay-head` | ⬜ Pending |
| 36 | GET | `/api/PayrollAPI/attendance-type` | ⬜ Pending |
| 37 | GET | `/api/VoucherAPI/sales-voucher` | ⬜ Pending |
| 38 | GET | `/api/VoucherAPI/purchase-voucher` | ⬜ Pending |
| 39 | GET | `/api/VoucherAPI/debitNote-voucher` | ⬜ Pending |
| 40 | GET | `/api/VoucherAPI/creditNote-voucher` | ⬜ Pending |
| 41 | GET | `/api/VoucherAPI/receipt-voucher` | ⬜ Pending |
| 42 | GET | `/api/VoucherAPI/payment-voucher` | ⬜ Pending |
| 43 | GET | `/api/VoucherAPI/contra-voucher` | ⬜ Pending |
| 44 | GET | `/api/VoucherAPI/journal-voucher` | ⬜ Pending |
| 45 | POST | `/api/MastersAPI/update-ledger-group` | ⬜ Pending |
| 46 | POST | `/api/MastersAPI/update-ledger-master` | ⬜ Pending |
| 47 | POST | `/api/MastersAPI/update-stock-master` | ⬜ Pending |
| 48 | POST | `/api/MastersAPI/update-stock-group` | ⬜ Pending |
| 49 | POST | `/api/MastersAPI/update-stock-category` | ⬜ Pending |
| 50 | POST | `/api/MastersAPI/update-statutory-master` | ⬜ Pending |
| 51 | POST | `/api/PayrollAPI/update-employee-group` | ⬜ Pending |
| 52 | POST | `/api/PayrollAPI/update-employee` | ⬜ Pending |
| 53 | POST | `/api/PayrollAPI/update-pay-head` | ⬜ Pending |
| 54 | POST | `/api/PayrollAPI/update-attendance-type` | ⬜ Pending |
| 55 | POST | `/api/VoucherAPI/update-sales-voucher` | ⬜ Pending |
| 56 | POST | `/api/VoucherAPI/update-purchase-voucher` | ⬜ Pending |
| 57 | POST | `/api/VoucherAPI/update-debitnote-voucher` | ⬜ Pending |
| 58 | POST | `/api/VoucherAPI/update-creditnote-voucher` | ⬜ Pending |
| 59 | POST | `/api/VoucherAPI/update-receipt-voucher` | ⬜ Pending |
| 60 | POST | `/api/VoucherAPI/update-payment-voucher` | ⬜ Pending |
| 61 | POST | `/api/VoucherAPI/update-contra-voucher` | ⬜ Pending |
| 62 | POST | `/api/VoucherAPI/update-journal-voucher` | ⬜ Pending |
