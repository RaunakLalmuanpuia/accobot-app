            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-4">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="grid grid-cols-12 px-6 py-3 bg-gray-50 border-b border-gray-100 text-xs font-semibold uppercase tracking-wide text-gray-400">
                        ...
                        <div class="col-span-2">Serial No.</div>
                        <div class="col-span-2">Licence Type</div>
                    ...
                    <div v-for="item in filtered" :key="item.id"
                        ...
                        <div class="col-span-3">
                            ...
                            <p v-if="item.address" class="text-xs text-gray-400 mt-0.5 truncate">{{ item.address }}</p>
                        </div>
                        ...
                        <div class="col-span-2 text-sm text-gray-600 font-mono">{{ item.tally_serial_no ?? '—' }}</div>
            ...
            <div class="relative z-50 w-full max-w-md bg-white shadow-xl flex flex-col">
                ...
                <form @submit.prevent="submit" class="flex-1 overflow-y-auto px-6 py-5 space-y-4">
                    <div>
                        ...
                        <input v-model="form.company_name" type="text" placeholder="e.g. Aignite Technologies"
                    ...
                    <div>
                        ...
                        <textarea v-model="form.address" rows="2" placeholder="Street, area…"
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input v-model="form.state" type="text" placeholder="e.g. Maharashtra"
                                   class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500" />
                        </div>
                        <div>
