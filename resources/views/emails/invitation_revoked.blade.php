...
<body style="font-family: sans-serif; background: #f9fafb; padding: 40px 0; margin: 0;">
    <div style="max-width: 480px; margin: 0 auto; background: #fff; border-radius: 12px; border: 1px solid #e5e7eb; padding: 40px;">
        ...
        <h2 style="margin: 0 0 8px; font-size: 20px; color: #111827;">Invitation cancelled</h2>
        <p style="margin: 0 0 24px; color: #6b7280; font-size: 15px;">
            Your invitation to join <strong>{{ $invitation->tenant->name }}</strong>
            @if($invitation->role)
                as <strong>{{ $invitation->role->name }}</strong>
            @endif
            has been withdrawn by the team.
        </p>

        <p style="margin: 0; font-size: 13px; color: #9ca3af;">
            If you believe this is a mistake, please contact the team directly.
        </p>
    </div>
</body>
</html>
