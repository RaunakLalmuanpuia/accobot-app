...
class NarrationSuggestionAgent implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        3. Identify or deduce the `party_name`:
           ...
           - If the transaction is an internal bank deduction or credit (e.g., "Sms Charges", "Int.Pd", "Consolidated Charges"), set party_name to "Bank".
           - Strip out unnecessary identifiers, UTR numbers, or dates.
        4. Rate your confidence from 0.0 to 1.0. Only give 0.9+ when very sure.
