  ...
  "Data": [
    {
      ...
      "Guid": "248b1a3e-7f9f-443c-ae33-1984824e53f7",
      "CompanyName": "Accobot",
      "FormalName": "Accobot",
      "Email": "",
      "PhoneNumber": "",
      ...
      "Logopath": "",
      "PriceLevel": "",
      "ConnectName": "Shopify Demo",
      "DBName": "Accobot",
      "NameAlias": "Accobot",
      "CompanyNumber": "100000",
      "StatutoryVersion": "0",
      "CorporateIdentityNo": "",
      "Address1": "A",
      "Address2": "B",
      ...
      "Address4": "",
      "Address5": "",
      "StartingFrom": "1-Apr-24",
      "BooksFrom": "1-Apr-24",
      "AuditedUpto": "4-Sep-26",
      "FIFOApplicableFrom": "1-Apr-24",
      "ReturnsStartFrom": "",
      "ThisYearBeg": "1-Apr-26",
      "ThisYearEnd": "31-Mar-27",
      "PrevYearBeg": "1-Apr-25",
      "PrevYearEnd": "31-Mar-26",
      "ThisQuarterBeg": "1-Jan-27",
      "ThisQuarterEnd": "31-Mar-27",
      "PrevQuarterBeg": "1-Jan-26",
      "PrevQuarterEnd": "31-Mar-26",
      "IncomeTaxNumber": "AAICI2170A",
      "SalesTaxNumber": "",
      "InterstateSTNumber": "",
      "TANumber": "JPRB01648D",
      ...
      "CmpTypeOfSupply": "",
      "HSNApplicability": "",
      "eWayBillApplicableType": "Value of Invoice",
      "eWayBillInterStateThreshold": "50,000.000",
      "IsSecurityOn": "No",
      "IsAccountingOn": "Yes",
      "IsInventoryOn": "Yes",
      "IsIntegrated": "Yes",
      ...
      "IsJobCostingOn": "No",
      "IsTCSOn": "Yes",
      "IsExciseReportsOn": "No",
      "IsCompositeDealer": "No",
      "IsBOMOn": "No",
      "IsDiscountsOn": "No",
      "CNoteAsInvoice": "No",
      "UKVATReturns": "No",
      ...
      "IsIndentOn": "No",
      "IsFBTOn": "No",
      "IsExciseMfgrTraderOn": "No",
      "IsSalesTaxOn": "No",
      "IsPayrollStatOn": "Yes",
      "ConnectCompany": "No",
      "ConnectCompanyOnLoad": "No",
      "IsEntryTaxApplicable": "No",
      "RevenueLedForOpBal": "No",
      "EnableSMSAccess": "No",
      "IsRcptsPymtsOn": "No",
      "IsLogoEnabled": "No",
      "IsXBRLOn": "No",
      ...
      "IsGSTOn": "Yes",
      "IsGSTClassifOn": "No",
      "IsGSTR1DownloadExcluded": "Yes",
      "IsGSTR2ADownloadExcluded": "Yes",
      "IsGSTR2BDownloadExcluded": "No",
      "IsGSTR3BDownloadExcluded": "Yes",
      "IsMultiAddressOn": "No",
      "IsEbankingOn": "No",
      "IsJobWorkOn": "Yes",
      "IsCostTrackingOn": "No",
      "EnablePwdPolicy": "No",
      "IsEditLogOn": "No",
      "IsPaymentRequestOn": "No",
      "IsGSTeInvInclEWayBill": "Yes",
      "PrinteWayBill": "No",
      "IsAggregate": "No",
      "IndianVAT": "No",
      "IsVATRegdDealer": "No",
      "IsVATCompositeDealer": "No",
      "IsAuditWorkingPaperOn": "No",
      "IsAuditCategoryOn": "No",
      "IsRoundOffExceOn": "No",
      "IsCSTWithAddlTax": "Yes",
      "IsSalesTaxCessOn": "No",
      "IsExciseClassificationOn": "No",
      "STIsSTLargeTaxPayer": "No",
      "STXIsRoundOffApplicable": "Yes",
      "ServiceTaxIsSEZ": "No",
      "STIsMultiUnit": "No",
      "STIsInputServDistributor": "No",
      "IsSTStockItemOn": "No",
      "IsReverseApplicable": "No",
      "STIsMonthlyReturns": "No",
      "IsTDSStockItemOn": "No",
      "IsFBTSurchargeApplicable": "No",
      "XBRLIsConsolidatedRepType": "No",
      "IsLBTOn": "No",
      "IsVATClassOn": "No",
      "IsMRPOn": "No",
      "IsRevisedAnnexureOn": "No",
      "EnableVATOnItemRate": "No",
      "EnableVATOnQuantity": "No",
      "IsInZRBasicServices": "No",
      "IsDesignatedZone": "No",
      "STMaintainSepAccForExempt": "No",
      "IsDeviceDetailsReq": "No",
      "CMPIsUnderNPVScheme": "No",
      "IsDaywiseCashAggregate": "No",
      "IsFIFOApplied": "Yes",
      "TDSDeductorType": "Company",
      "TDSPymtPeriod": "",
      "TCSPymtPeriod": "",
      "DeductorWard": "",
      "DeductorStatus": "",
      "DeductorBranch": "JAIPUR",
      "DeductorType": "No",
      "DeductorRespPersonName": "ABC",
      "DeductorRespPersonDesig": "DIRECTOR",
      "DeductorRespPersonFatherName": "AAA",
      "HeadOfficeTANumber": "",
      "PersonResponsiblePAN": "AKGPH6123N",
      "PersonResponsibleFlatNo": "A",
      "PersonResponsiblePremises": "B",
      "PersonResponsibleRoad": "V",
      "PersonResponsibleArea": "",
      "PersonResponsibleCity": "JAIPUR",
      "PriorPersonResponsibleState": "",
      "PersonResponsibleState": "Rajasthan",
      "PersonResponsiblePincode": "110011",
      "PersonResponsibleMobile": "9799789000",
      "PersonResponsibleSTDCode": "0141",
      "PersonResponsiblePhone": "093344",
      "PersonResponsibleEMail": "abc@gmail.com",
      "PersonResponsibleAltSTDCode": "",
      "PersonResponsibleAltPhone": "",
      "PersonResponsibleAltEMail": "",
      "PersonResponsibleAltMobile": "",
      "DeductorResponsibleAltSTDCode": "",
      "DeductorResponsibleAltPhone": "",
      "DeductorResponsibleAltEMail": "",
      "DeductorResponsibleAltMobile": "",
      "ITDeductorType": "No",
      "ITDeductorWard": "",
      "ITDeductorBranch": "",
      "ITDeductorRespPersonName": "",
      "ITDeductorRespPersonFatherName": "",
      "ITDeductorRespPersonDesig": "",
      "ITDeductorRespPersonPAN": "",
      "TANRegNo": "JPRB01648D",
      "IgnoreITExemption": "No",
      "IgnoreTCSITExemption": "No",
      "TDSNatureofPayment": "",
      "TCSNatureofGood": "",
      "VATTINNumber": "",
      "CompositeTIN": "",
      ...
      "CMPVATTINValidTill": "",
      "CMPEntitlementDate": "",
      "CMPExemptionExpiryDate": "",
      "CMPExemptionExtentFrom": "",
      "CMPExemptionExtentTo": "",
      "VATPymtPeriod": "",
      "CSTPymtPeriod": "",
      "VATFilingPeriodicity": "",
      "VATReturnForm": "",
      "CMPVATPostBoXNo": "",
      "CMPVATTown": "",
      "CMPVATStreet": "",
      ...
      "CMPCircleDivision": "",
      "CMPTradeName": "",
      "CMPAssessingAuthority": "",
      "CMPSONDaughter": "",
      "CMPEntitlementCertificateNo": "",
      "CMPDealerStatus": "",
      "CMPFaxNumber": "",
      "CMPCompTaxSlNo": "",
      "CMPExemptionName": "",
      "CMPTaxIssuedPerson": "",
      "CMPTaxIssuedDesignation": "",
      "CMPLumpSumPermissionNo": "",
      "CMPProfTaxEnrolNo": "",
      "CMPProfTaxRegnNo": "",
      "CMPExemptCertificateNo": "",
      "CMPEcoActivityCode": "",
      "CMPAuthPersnName": "",
      "CMPTaxAuthPerson": "",
      "CMPAuthPersnDesgnation": "",
      "CMPTaxAuthDesignation": "",
      "VATOldTINNumber": "",
      "VATDistrictName": "",
      "VATDealerType": "Regular",
      "VATLastOnlineActivityDateTime": "",
      "VATTreasury": "",
      "VATType": "",
      "UDF_VATDDChequeNo": "",
      "ExportImportCode": "",
      ...
      "ExciseFocalBankName": "",
      "ExciseFocalBankAddr": "",
      "DeactivateExciseFrom": "",
      "PFPymtPeriod": "",
      "CMPPFCode": "Abc001",
      "CMPPFAccountGroupCode": "",
      "CMPPFSecurityCode": "",
      "ESIPymtPeriod": "",
      "CMPESICode": "",
      "CMPESIBranchOffice": "",
      "CMPESIWorkingDays": "0",
      "CMPESIEligibleAmount": "10,000.000",
      "PTPymtPeriod": "",
      "FBTPymtPeriod": "",
      "FBTYearEndPymtPeriod": "",
      "CompanyFBTAssesseeType": "",
      "CompanyFBTAssesseeCategory": "Default",
      "LBTRegnDate": "",
      "LBTRegnNo": "",
      "LBTZone": "",
      ...
      "GSTDownloadApplFor": "",
      "GSTDownloadApplReg": "",
      "GSTDownloadNotApplReg": "",
      "CMPIECCode": "",
      "CMPEmployerId": "",
      "CompanyNameNative": "",
      "CompanyEmirateNative": "",
      "CompanyCountryNative": "",
      "SMSShortCode": "",
      "SMSPrefix": "",
      ...
      "DocumentKey": "",
      "AccountId": "",
      "AutoSetOffAdvRcptPymtFromPrev": "",
      "OnlineReconApplicableFrom": "",
      "RTGSLimit": "",
      "VATPymtDueDate": "0",
      "CSTPymtDueDate": "0",
      "STPymtDueDate": "0",
      ...
      "ESIPymtDueDate": "0",
      "FBTPymtDueDate": "0",
      "FBTYearEndPymtDueDate": "0",
      "STCrAdjPercent": "0",
      "CmpTaxAmountTolerence": "0",
      "CMPAllowedExemptionAmt": "",
      "CMPExemptionExtentAmt": "",
      "UDF_HSNCode": "",
...
| `Guid` | string | yes | Tally company GUID — unique key for upsert |
| **Identity** | | | |
| `CompanyName` | string | no | Company name |
| `FormalName` | string | no | Formal/legal name |
| `NameAlias` | string | no | Alias name |
| `Email` | string | no | Company email |
| `PhoneNumber` | string | no | Phone |
| `FaxNumber` | string | no | Fax |
| `Website` | string | no | Website URL |
| `MobileNumbers` | string | no | Mobile numbers |
| `Address` | string | no | Primary address |
| `Address1`–`Address5` | string | no | Address lines 1–5 |
| `State` | string | no | State |
| `PriorState` | string | no | Prior state |
| `Country` | string | no | Country |
| `CountryISDCode` | string | no | ISD code e.g. `"+91"` |
| `Pincode` | string | no | PIN / postal code |
| `BranchName` | string | no | Branch name |
| `BranchName2` | string | no | Secondary branch name |
| `Logopath` | string | no | Path to company logo |
| `PriceLevel` | string | no | Price level |
| `ConnectName` | string | no | Tally Connect name |
| `DBName` | string | no | Tally database name |
| `NameAlias` | string | no | Name alias |
| `CompanyNumber` | string | no | Company number |
| `StatutoryVersion` | string | no | Statutory version |
| `CorporateIdentityNo` | string | no | CIN |
| `TallySerialNo` | string | no | Tally serial number |
| `TallyLicenseType` | string | no | Licence type e.g. `"Gold"`, `"Silver"` |
| **Tax Registration** | | | |
| `IncomeTaxNumber` | string | no | PAN / income tax number |
| `SalesTaxNumber` | string | no | Sales tax number |
| `InterstateSTNumber` | string | no | Interstate ST number |
| `TANumber` | string | no | TAN number |
| **GST** | | | |
| `GSTRegistrationNumber` | string | no | GSTIN |
| `GSTRegistrationType` | string | no | e.g. `"Regular"`, `"Composition"` |
| `GSTApplicableDate` | string | no | GST applicable from date |
| `GSTApplicability` | string | no | GST applicability |
| `CmpTypeOfSupply` | string | no | Type of supply |
| `HSNApplicability` | string | no | HSN applicability |
| `eWayBillApplicableType` | string | no | e.g. `"Value of Invoice"` |
| `eWayBillInterStateThreshold` | string | no | Interstate threshold value |
| **Financial Periods** | | | |
| `StartingFrom` | string | no | Company start date |
| `BooksFrom` | string | no | Books start date |
| `AuditedUpto` | string | no | Audited up to date |
| `FIFOApplicableFrom` | string | no | FIFO applicable from |
| `ReturnsStartFrom` | string | no | Returns start date |
| `ThisYearBeg` / `ThisYearEnd` | string | no | Current financial year range |
| `PrevYearBeg` / `PrevYearEnd` | string | no | Previous financial year range |
| `ThisQuarterBeg` / `ThisQuarterEnd` | string | no | Current quarter range |
| `PrevQuarterBeg` / `PrevQuarterEnd` | string | no | Previous quarter range |
| **Feature Flags** | | | |
| `IsSecurityOn`, `IsAccountingOn`, `IsInventoryOn`, `IsIntegrated`, `IsBillWiseOn`, `IsAllBillWiseOn`, `IsCostCentresOn`, `IsBatchWiseOn`, `IsPerishableOn`, `IsRemindersOn`, `IsExciseOn`, `IsChqPrintingOn`, `DiffActualQty`, `UseZeroEntries`, `AddlAmount`, `IsTallyAuditOn`, `IsPayrollOn`, `IsTDSOn`, `IsServiceTaxOn`, `IsJobCostingOn`, `IsTCSOn`, `IsExciseReportsOn`, `IsCompositeDealer`, `IsBOMOn`, `IsDiscountsOn`, `CNoteAsInvoice`, `UKVATReturns`, `UsePriceLevels`, `IsInterestOn`, `IsAdvInterestOn`, `PurcAsInvoice`, `DNoteAsInvoice`, `AllowinMobile`, `IsIndentOn`, `IsFBTOn`, `IsExciseMfgrTraderOn`, `IsSalesTaxOn`, `IsPayrollStatOn`, `ConnectCompany`, `ConnectCompanyOnLoad`, `IsEntryTaxApplicable`, `RevenueLedForOpBal`, `EnableSMSAccess`, `IsRcptsPymtsOn`, `IsLogoEnabled`, `IsXBRLOn`, `IsProprietorship`, `IsYearWise`, `IsCmpLTUOn`, `IsGSTOn`, `IsGSTClassifOn`, `IsGSTR1DownloadExcluded`, `IsGSTR2ADownloadExcluded`, `IsGSTR2BDownloadExcluded`, `IsGSTR3BDownloadExcluded`, `IsMultiAddressOn`, `IsEbankingOn`, `IsJobWorkOn`, `IsCostTrackingOn`, `EnablePwdPolicy`, `IsEditLogOn`, `IsPaymentRequestOn`, `IsGSTeInvInclEWayBill`, `PrinteWayBill`, `IsAggregate`, `IndianVAT`, `IsVATRegdDealer`, `IsVATCompositeDealer`, `IsAuditWorkingPaperOn`, `IsAuditCategoryOn`, `IsRoundOffExceOn`, `IsCSTWithAddlTax`, `IsSalesTaxCessOn`, `IsExciseClassificationOn`, `STIsSTLargeTaxPayer`, `STXIsRoundOffApplicable`, `ServiceTaxIsSEZ`, `STIsMultiUnit`, `STIsInputServDistributor`, `IsSTStockItemOn`, `IsReverseApplicable`, `STIsMonthlyReturns`, `IsTDSStockItemOn`, `IsFBTSurchargeApplicable`, `XBRLIsConsolidatedRepType`, `IsLBTOn`, `IsVATClassOn`, `IsMRPOn`, `IsRevisedAnnexureOn`, `EnableVATOnItemRate`, `EnableVATOnQuantity`, `IsInZRBasicServices`, `IsDesignatedZone`, `STMaintainSepAccForExempt`, `IsDeviceDetailsReq`, `CMPIsUnderNPVScheme`, `IsDaywiseCashAggregate`, `IsFIFOApplied` | string (`"Yes"`/`"No"`) | no | Stored together in `feature_flags` jsonb |
| **Deductor / TDS Details** | | | |
| `TDSDeductorType`, `TDSPymtPeriod`, `TCSPymtPeriod`, `TDSNatureofPayment`, `TCSNatureofGood`, `DeductorWard`, `DeductorStatus`, `DeductorBranch`, `DeductorType`, `DeductorRespPersonName`, `DeductorRespPersonDesig`, `DeductorRespPersonFatherName`, `HeadOfficeTANumber`, `PersonResponsiblePAN`, `PersonResponsibleFlatNo`, `PersonResponsiblePremises`, `PersonResponsibleRoad`, `PersonResponsibleArea`, `PersonResponsibleCity`, `PriorPersonResponsibleState`, `PersonResponsibleState`, `PersonResponsiblePincode`, `PersonResponsibleMobile`, `PersonResponsibleSTDCode`, `PersonResponsiblePhone`, `PersonResponsibleEMail`, `PersonResponsibleAltSTDCode`, `PersonResponsibleAltPhone`, `PersonResponsibleAltEMail`, `PersonResponsibleAltMobile`, `DeductorResponsibleAltSTDCode`, `DeductorResponsibleAltPhone`, `DeductorResponsibleAltEMail`, `DeductorResponsibleAltMobile`, `ITDeductorType`, `ITDeductorWard`, `ITDeductorBranch`, `ITDeductorRespPersonName`, `ITDeductorRespPersonFatherName`, `ITDeductorRespPersonDesig`, `ITDeductorRespPersonPAN`, `TANRegNo`, `IgnoreITExemption`, `IgnoreTCSITExemption` | string | no | Stored together in `deductor_details` jsonb |
| **Legacy Tax (VAT / CMP / CST / ST / Excise / PF / ESI / FBT / LBT)** | | | |
| `VATTINNumber`, `CompositeTIN`, `EECDebtors`, `EECCreditors`, `VatApplDate`, `CompositeApplicableDate`, `VATRegDate`, `VATRegistrationDate`, `CSTRegistrationDate`, `CSTApplDate`, `DeactivateVATFrom`, `CMPVATTINValidTill`, `CMPEntitlementDate`, `CMPExemptionExpiryDate`, `CMPExemptionExtentFrom`, `CMPExemptionExtentTo`, `VATPymtPeriod`, `CSTPymtPeriod`, `VATFilingPeriodicity`, `VATReturnForm`, `CMPVATPostBoXNo`, `CMPVATTown`, `CMPVATStreet`, `CMPVATBuilding`, `CMPAuthorisedPlace`, `CMPCircleWard`, `CMPImportExportCode`, `CMPCircleSector`, `CMPCircleDivision`, `CMPTradeName`, `CMPAssessingAuthority`, `CMPSONDaughter`, `CMPEntitlementCertificateNo`, `CMPDealerStatus`, `CMPFaxNumber`, `CMPCompTaxSlNo`, `CMPExemptionName`, `CMPTaxIssuedPerson`, `CMPTaxIssuedDesignation`, `CMPLumpSumPermissionNo`, `CMPProfTaxEnrolNo`, `CMPProfTaxRegnNo`, `CMPExemptCertificateNo`, `CMPEcoActivityCode`, `CMPAuthPersnName`, `CMPTaxAuthPerson`, `CMPAuthPersnDesgnation`, `CMPTaxAuthDesignation`, `VATOldTINNumber`, `VATDistrictName`, `VATDealerType`, `VATLastOnlineActivityDateTime`, `VATTreasury`, `VATType`, `UDF_VATDDChequeNo`, `ExportImportCode`, `AuthorisedPersonName`, `AuthorisedPersonDesignation`, `AuthorisedPlace`, `CircleSector`, `CircleDivision`, `CircleWard`, `TaxAuthorisedPerson`, `TaxInvoiceCode`, `TaxInvoiceNo`, `LineOfBusiness`, `STRegDate`, `DeactivateServiceTaxFrom`, `STRegNumber`, `STAssesseeCode`, `STOrgType`, `STMajorService`, `STDivisionCode`, `STDivisionName`, `STRangeCode`, `STRangeName`, `STCommrtCode`, `STCommrtName`, `STFocalBankCode`, `STFocalBankName`, `STFocalBankAddr`, `STAdjExpenses`, `STLargeTaxPayerUnit`, `STPremisesCodeNo`, `ServiceTaxLiabilityType`, `RevChargeType`, `STPymtPeriod`, `ExciseRegn`, `ExciseRange`, `ExciseRangeAddress`, `ExciseDivision`, `ExciseDivisionAddress`, `ExciseAssesseeType`, `ExciseCommissionerate`, `ExciseRangeCode`, `ExciseDivisionCode`, `ExciseFocalBankCode`, `ExciseFocalBankName`, `ExciseFocalBankAddr`, `DeactivateExciseFrom`, `PFPymtPeriod`, `CMPPFCode`, `CMPPFAccountGroupCode`, `CMPPFSecurityCode`, `ESIPymtPeriod`, `CMPESICode`, `CMPESIBranchOffice`, `CMPESIWorkingDays`, `CMPESIEligibleAmount`, `PTPymtPeriod`, `FBTPymtPeriod`, `FBTYearEndPymtPeriod`, `CompanyFBTAssesseeType`, `CompanyFBTAssesseeCategory`, `LBTRegnDate`, `LBTRegnNo`, `LBTZone`, `EconomicActivityCode`, `XBRLCIN`, `XBRLIndustryType`, `GSTDownloadApplFor`, `GSTDownloadApplReg`, `GSTDownloadNotApplReg`, `CMPIECCode`, `CMPEmployerId`, `CompanyNameNative`, `CompanyEmirateNative`, `CompanyCountryNative`, `SMSShortCode`, `SMSPrefix`, `CompanyContactPerson`, `CompanyContactNumber`, `CompanySMSName`, `CompanyChequeName`, `CRNumber`, `BranchCRNumber`, `AdminEmailID`, `DocumentKey`, `AccountId`, `AutoSetOffAdvRcptPymtFromPrev`, `OnlineReconApplicableFrom`, `RTGSLimit`, `VATPymtDueDate`, `CSTPymtDueDate`, `STPymtDueDate`, `TDSPymtDueDate`, `TCSPymtDueDate`, `PFPymtDueDate`, `PTPymtDueDate`, `ESIPymtDueDate`, `FBTPymtDueDate`, `FBTYearEndPymtDueDate`, `STCrAdjPercent`, `CmpTaxAmountTolerence`, `CMPAllowedExemptionAmt`, `CMPExemptionExtentAmt`, `UDF_HSNCode`, `InterstateOldSTNumber`, `VNSName` | string | no | Stored together in `legacy_tax_details` jsonb |
...
Returns pending company records for the tenant (queued when the user edits company details in the Accobot UI). The response echoes back every field received during inbound sync.
...
| `TallyId` | Tally's assigned ID — `null` for new records |
| `Guid` | Company GUID from inbound sync |
| All other fields | Echoed back exactly as received during inbound — see §1.8 for the full field list grouped by Identity, Tax, GST, Financial Periods, Feature Flags, Deductor Details, and Legacy Tax |
