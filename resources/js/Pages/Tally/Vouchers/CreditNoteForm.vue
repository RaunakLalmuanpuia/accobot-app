...
const sundryDebtorLedgers = computed(() => {
    const f = props.ledgers.filter(l => l.group_name?.toLowerCase().includes('sundry debtor'))
...
<template>
    <div class="grid grid-cols-2 gap-3">
        <div>
            ...
            <input v-model="form.voucher_number" type="text" placeholder="e.g. CN-001"
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Original Invoice Ref</label>
            <input v-model="form.reference" type="text" placeholder="Original invoice number"
                   class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500" />
        </div>
        <div>
    ...
    <div class="grid grid-cols-2 gap-3">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Party Name <span class="text-red-500">*</span></label>
            ...
            <div v-if="expandedItems.has(i)" class="border-t border-gray-100 bg-gray-50 px-3 pt-3 pb-2 space-y-3">
                <div class="grid grid-cols-3 gap-2">
                    ...
                    <div>
                        ...
                        <input v-model="ie.sales_ledger" type="text" list="cn-ledger-list"
                               class="w-full rounded border border-gray-300 px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-violet-500" />
                    </div>
                    <div>
    ...
    <div class="rounded-lg bg-yellow-50 border border-yellow-200 p-4 space-y-2">
        <h3 class="text-sm font-semibold text-yellow-800 mb-3">Credit Note Summary</h3>
        ...
        <div class="flex items-center justify-between text-sm pt-1 border-t border-yellow-200">
            <span class="font-medium text-gray-800">Total</span>
            <div class="flex items-center gap-2">
                <input v-model="form.voucher_total" @input="grandTotalLocked = true"
                       type="number" step="0.01"
                       class="w-36 text-right rounded border border-yellow-300 px-2 py-1 text-sm font-mono font-medium focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white" />
    ...
    <div>
        ...
        <textarea v-model="form.narration" rows="2" placeholder="Reason for credit note…"
