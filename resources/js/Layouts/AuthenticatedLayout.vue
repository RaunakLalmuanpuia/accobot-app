        ...
        >
            ...
            <nav class="flex-1 space-y-0.5 overflow-y-auto px-2 py-3">
                ...
                <template v-if="isAdmin() && !currentTenantId()">
                    ...
                    <SidebarNavLink :href="route('admin.billing')" :active="route().current('admin.billing')">
                    ...
                    <template v-if="hasPermission('integrations.view') && hasFeature('tally_sync')">
                        ...
                        <div v-show="tallyOpen" class="ml-2 space-y-0.5 border-l-2 border-gray-100 pl-3">
                            ...
                            <div class="pt-1 pb-0.5">
                                <Link :href="route('tally.stock-masters.index', { tenant: currentTenantId() })"
                                      class="flex items-center gap-1.5 px-1 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-gray-400 hover:text-violet-600 transition">
                                    <svg class="h-3 w-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>
                                    Stock Masters
                                </Link>
                                <div class="ml-2 mt-0.5 space-y-0.5 border-l border-gray-100 pl-2">
                                    <SidebarNavLink :href="route('tally.stock-groups.index', { tenant: currentTenantId() })" :active="route().current('tally.stock-groups.index')">
                                        <svg class="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                                        Stock Groups
                                    </SidebarNavLink>
                                    <SidebarNavLink :href="route('tally.stock-categories.index', { tenant: currentTenantId() })" :active="route().current('tally.stock-categories.index')">
                                        <svg class="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a2 2 0 012-2z"/></svg>
                                        Categories
                                    </SidebarNavLink>
                                    <SidebarNavLink :href="route('tally.godowns.index', { tenant: currentTenantId() })" :active="route().current('tally.godowns.index')">
                                        <svg class="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                                        Godowns
                                    </SidebarNavLink>
                                    <SidebarNavLink :href="route('tally.units.index', { tenant: currentTenantId() })" :active="route().current('tally.units.index')">
                                        <svg class="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                                        Units
                                    </SidebarNavLink>
                                </div>
                            </div>
